...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            addGroup(){
                this.$router.push({path:'/Index/addgroupone',query:{type:''}})
            },
            search(){
                let params = {
            ...
            see(row){
                this.$router.push({path:'/Index/addgroupone',query:{id:row.id,type:'see'}})
            },
            editGroup(row){
                this.$router.push({path:'/Index/addgroupone',query:{id:row.id,type:'edit'}})
            },
            addFace(){
